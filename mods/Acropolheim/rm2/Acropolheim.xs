/* Map Name: Acropolheim.xs
 * Jotunheim themed like Acropolis
*/
...
void main(void){
   ...
   rmAddConnectionTerrainReplacement(connectionID, "cliffGreekA", "GrassB");
   rmAddConnectionTerrainReplacement(connectionID, "cliffGreekB", "GrassB");
   rmAddConnectionTerrainReplacement(connectionID, "cliffGreekA", "GrassB");
   ...
   if(secondConnectionExists == 1){
      ...
      rmAddConnectionTerrainReplacement(alternateConnection, "cliffGreekA", "GrassB");
      rmAddConnectionTerrainReplacement(alternateConnection, "cliffGreekB", "GrassB");
      rmAddConnectionTerrainReplacement(alternateConnection, "cliffGreekA", "GrassB");
   ...
   for(i=1; <cNumberPlayers){
      ...
      rmAddAreaTerrainLayer(id, "GrassDirt25", 4, 12);
      rmAddAreaTerrainLayer(id, "GrassA", 0, 4);
   }
   rmBuildAllAreas();
   ...
   if(cMapSize > 0){
      //And one last time if Large or Giant.
   ...
   rmAddObjectDefItem(startingHuntableID, "zebra", rmRandInt(4,12), 3.0);
   ...
   rmAddObjectDefItem(closeCowsID, "goat", 4, 2.0);
   ...
   rmAddObjectDefItem(stragglerTreeID, "oak", 1, 0.0);
   ...
   rmAddObjectDefItem(mediumDeerID, "rhinocerous", numHuntable, 3.0);
   ...
   if(bonusChance<0.3) {
      rmAddObjectDefItem(bonusHuntableID, "zebra", 12, 2.0);
   }else if(bonusChance<0.6) {
      rmAddObjectDefItem(bonusHuntableID, "zebra", 12, 2.0);
   } else {
      rmAddObjectDefItem(bonusHuntableID, "elephant", 3, 2.0);
   }
   ...
   if(bonusChance3<0.3) {
      rmAddObjectDefItem(bonusHuntableID2, "baboon", 10, 2.0);
   } else if(bonusChance3<0.6) {
      rmAddObjectDefItem(bonusHuntableID2, "giraffe", 6, 2.0);
   } else {
   ...
   rmAddObjectDefItem(farCowsID, "zebra", 6, 4.0);
   ...
   rmAddObjectDefItem(farPredatorID, "hyena", 4, 4.0);
   ...
   rmAddObjectDefItem(randomTreeID, "oak", 1, 0.0);
   ...
   if(cMapSize == 2){
      ...
      if(bonusChance<0.5) {
         ...
         rmAddObjectDefItem(giantHuntableID, "zebra", 14, 3.0);
      } else {
         rmAddObjectDefItem(giantHuntableID, "giraffe", 5, 4.0);
      }
      ...
      if(bonusChance<0.5) {
         ...
         rmAddObjectDefItem(giantHuntable2ID, "giraffe", 5, 3.0);
      } else {
         rmAddObjectDefItem(giantHuntable2ID, "rhinocerous", 5, 4.0);
      }
