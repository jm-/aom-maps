...
void main(void)
{
   ...
   int size=2.7*sqrt(cNumberNonGaiaPlayers*playerTiles);
   ...
   rmAddObjectDefItem(closeCowsID, "cow", rmRandInt(2,5), 2.0);
   ...
   rmSetObjectDefMinDistance(closeBerriesID, 3.0);
   ...
   if(rmRandFloat(0,1)<0.75)
      rmAddObjectDefItem(closeElkID, "elk", rmRandInt(4,6), 4.0);
   else
   ...
   rmAddObjectDefItem(stragglerTreeID, "gaia forest tree", 1, 0.0);
   ...
   rmAddObjectDefItem(mediumCowID, "cow", rmRandFloat(2,3), 4.0);
   ...
   rmAddObjectDefItem(mediumDeerID, "deer", rmRandInt(3,8), 4.0);
   ...
   rmAddObjectDefItem(farCowID, "cow", rmRandInt(10,20), 4.0);
   ...
   if(bonusChance < 0.33)   
      rmAddObjectDefItem(bonusHuntableID, "elk", rmRandInt(3,16), 4.0);
   else if(bonusChance < 0.66)
      rmAddObjectDefItem(bonusHuntableID, "caribou", rmRandInt(3,12), 4.0);
   else
      rmAddObjectDefItem(bonusHuntableID, "aurochs", rmRandInt(3,8), 4.0);
   ...
   rmAddObjectDefItem(randomTreeID, "gaia forest tree", 1, 0.0);
   ...
   for(i=1; <cNumberPlayers)
   {
      ...
      // Set the size.
      rmSetAreaSize(id, 1.6*playerFraction, 1.8*playerFraction);
   ...
   for(i=1; <cNumberPlayers)
   {
      ...
      rmSetAreaSize(id2, rmAreaTilesToFraction(150), rmAreaTilesToFraction(300));
   ...
   {
      // Beautification sub area.
      int id4=rmCreateArea("Grass road patch 2 "+i);
      rmSetAreaSize(id4, rmAreaTilesToFraction(5), rmAreaTilesToFraction(20));
      rmSetAreaTerrainType(id4, "GreekRoadA");
   ...
   {
      // Beautification sub area.
      int id5=rmCreateArea("Greek road patch 3 "+i);
      rmSetAreaSize(id5, rmAreaTilesToFraction(5), rmAreaTilesToFraction(25));
      rmSetAreaTerrainType(id5, "GreekRoadA");
   ...
   id=rmAddFairLoc("Settlement", false, true,  80, 130, 60, 10);

   id=rmAddFairLoc("Settlement", true, false,  90, 150, 60, 10);
 ...
 // Ruins
   ...
   for(i=0; <2*cNumberNonGaiaPlayers)
   {
      ...
      if(rmRandFloat(0,1)<0.15)
         rmAddObjectDefItem(columnID, "healing spring object", 1, 0.0);
      rmAddObjectDefItem(columnID, "ruins", rmRandInt(0,1), 0.0);
      rmAddObjectDefItem(columnID, "columns", rmRandFloat(0,4.0), 4.0);
   ...
   for(i=0; <numTries)
   {
      ...
      rmSetAreaSize(forestID, rmAreaTilesToFraction(rmRandInt(600,1200)), rmAreaTilesToFraction(rmRandInt(600,1200)));
      ...
      rmSetAreaMaxBlobDistance(forestID, 80.0);
